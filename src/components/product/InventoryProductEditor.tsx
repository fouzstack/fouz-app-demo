...
export default function InventoryProductEditor() {
  ...
  return (
    <div className='min-h-screen w-full flex flex-col items-center justify-center text-gray-300  py-8 bg-gradient-to-br from-black via-blue-900 to-black'>
      {showToaster && <Toaster />}
      ...
      <form
        ...
        className='w-full max-w-md min-w-[320px] rounded-xl p-8 shadow-lg border'
      >
        <Input
          color='success'
          variant='underlined'
