...
const CreateProductForm = () => {
  ...
  const getMarginIcon = () => {
    if (margin >= 30) return <ChartBarIconSolid className="w-5 h-5 text-emerald-400" />;
    if (margin >= 15) return <ChartBarIcon className="w-5 h-5 text-amber-400" />;
    return <ExclamationTriangleIconSolid className="w-5 h-5 text-red-400" />;
  };

  const getMarginLevel = () => {
    if (margin >= 30) return { label: 'Excelente', color: 'bg-emerald-500', icon: '📈' };
    if (margin >= 15) return { label: 'Aceptable', color: 'bg-amber-500', icon: '📊' };
  ...
  const isFormValid = watchedName && watchedUnit && watchedCost > 0 && watchedPrice > 0;
        ...
        <div className="hidden md:flex items-center justify-between mb-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm">Complete todos los campos requeridos</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="pt-8 mt-8 border-t border-gray-800 space-y-4">
              ...
              <p className="text-xs text-gray-500 text-center">
                Los campos marcados con <span className="text-red-400">*</span> son requeridos
              </p>
            </div>
          </form>
        </div>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <h3 className="font-semibold text-gray-100">Análisis de Rentabilidad</h3>
                <p className="text-sm text-gray-400">Ver margen y recomendaciones</p>
              </div>
            </div>
            {showAnalysis ? (
              ...
              {isFormValid ? (
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="bg-[#0d0f12] border border-gray-800 rounded-xl p-4">
                      <p className="text-sm text-gray-400 mb-2">Ganancia por Unidad</p>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-amber-400/80">
                            Para un margen saludable de 30%, considera un precio de: 
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-400">
                    Completa todos los campos para ver el análisis de rentabilidad
                  </p>
                </div>
              )}
            </div>
        ...
        <div>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <h3 className="font-semibold text-gray-100">Consejos y Buenas Prácticas</h3>
                <p className="text-sm text-gray-400">Guía para precios óptimos</p>
              </div>
            </div>
            {showQuickTips ? (
              <ChevronUpIcon className="w-5 h-5 text-gray-400" />
            ...
            <div className="mt-2 bg-[#111318] border border-gray-800 rounded-2xl p-6 animate-fade-in">
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-medium text-gray-300">Margen Recomendado</p>
                    <p className="text-sm text-gray-500">
                      Para la mayoría de productos, un margen del 30% o más es ideal.
                      Considera costos adicionales como transporte, almacenamiento y marketing.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-medium text-gray-300">Nombres Descriptivos</p>
                    <p className="text-sm text-gray-500">
                      Usa nombres claros que incluyan marca, modelo y características principales.
                      Ej: "Laptop Dell XPS 13 - i7 16GB 512GB SSD" en lugar de solo "Laptop".
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-medium text-gray-300">Unidades Consistentes</p>
                    <p className="text-sm text-gray-500">
                      Mantén las mismas unidades para productos similares.
                      Si usas "kg" para un producto, no uses "gramos" para otro similar.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-medium text-gray-300">Revisión de Precios</p>
                    <p className="text-sm text-gray-500">
                      Revisa regularmente los precios de la competencia y ajusta según sea necesario.
                      Los precios de insumos pueden cambiar con el tiempo.
                    </p>
                  </div>
                </div>
              </div>
